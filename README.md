...
- Mines uses a 25-tile prize board: three tiles each for x2, x1.5, x1.2, x1, x0.5, x0.2 and x0, plus four losing mine tiles. One pick settles the round. Blackjack dealers hit soft 17 and naturals pay 6:5.
